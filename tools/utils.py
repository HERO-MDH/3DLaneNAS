...
def define_args():
    ...
    parser.add_argument('--data_dir', type=str,default='/media/nas/DISK1/data_splits/illus_chg', help='The path saving train.json and val.json files')
    parser.add_argument('--dataset_dir', type=str,default='/media/nas/DISK1/data_splits', help='The path saving actual data')
    parser.add_argument('--save_path', type=str, default='/media/zenact/data/Results', help='directory to save output')
    # Dataset settings
    ...
    parser.add_argument('--pitch', type=float, default=1, help='pitch angle of camera to ground in centi degree')
    ...
    parser.add_argument("--batch_norm", type=str2bool, nargs='?', const=False, default=True, help="apply batch norm")
    ...
    parser.add_argument('--nepochs', type=int, default=5, help='total numbers of epochs')
    ...
    parser.add_argument('--evaluate', action='store_true',default=True, help='only perform evaluation')
    ...
    parser.add_argument('--save_freq', type=int, default=1, help='padding')
    # Skip batch
